...
class Replys {
    ...
    async createReply(commentId, content) {
        await axios.post(`/reply/createReply`, { commentId, content }, {
...
`;
    ...
    async modifyReply(replyId, content) {
        await axios.put(`/reply/${replyId}`, { content }, {
            withCredentials: true
        });
    }
...
const replyRender = async () => {
    ...
    replyLikeBtn.forEach((el) => {
        ...
        el.onclick = async (e) => {
            ...
            await axios.post(`/reply-likes/like/${reply.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
    replyDisLikeBtn.forEach((el) => {
        ...
        el.onclick = async (e) => {
            ...
            await axios.post(`/reply-likes/dislike/${reply.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
