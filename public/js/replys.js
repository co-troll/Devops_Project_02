...
class Replys {
    ...
    async setReplys(id) {
        const { data } = await axios.get(`https://testcoffeetree.store/reply/${id}`);
    ...
    async createReply(commentId, content) {
        await axios.post(`https://testcoffeetree.store/reply/createReply`, { commentId, content }, {
...
`;
    ...
    async modifyReply(replyId, content) {
        await axios.put(`https://testcoffeetree.store/reply/${replyId}`, { content }, {
            withCredentials: true
        });
    }
    async deleteReply(replyId) {
        await axios.delete(`https://testcoffeetree.store/reply/${replyId}`, {
            withCredentials: true
        });
    }
}
const replyRender = async () => {
    ...
    replyLikeBtn.forEach((el) => {
        ...
        el.onclick = async (e) => {
            ...
            await axios.post(`https://testcoffeetree.store/reply-likes/like/${reply.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
    replyDisLikeBtn.forEach((el) => {
        ...
        el.onclick = async (e) => {
            ...
            await axios.post(`https://testcoffeetree.store/reply-likes/dislike/${reply.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
