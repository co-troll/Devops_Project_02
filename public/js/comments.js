...
class Comments {
    ...
    async setComment(id) {
        const { data } = await axios.get(`https://testcoffeetree.store/comment/${id}`);
        if (Object.keys(data).includes('status')) {
            ...
            for (let el of commentList) {
                this.comments.push({
                    ...
                    countReplys: (await axios.get(`https://testcoffeetree.store/reply/count/${el.id}`)).data
                });
            }
        }
    }
    async createComment(postId, content) {
        await axios.post(`https://testcoffeetree.store/comment/createComment`, { postId, content }, {
...
`;
    ...
    async modifyComment(commentId, content) {
        await axios.put(`https://testcoffeetree.store/comment/${commentId}`, { content }, {
            withCredentials: true
        });
    }
    async deleteComment(commentId) {
        await axios.delete(`https://testcoffeetree.store/comment/${commentId}`, {
            withCredentials: true
        });
    }
}
...
const commentRender = async () => {
    ...
    commentLikeBtn.forEach((el) => {
        el.onclick = async (e) => {
            ...
            await axios.post(`https://testcoffeetree.store/comment-likes/like/${comment.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
    commentDisLikeBtn.forEach((el) => {
        el.onclick = async (e) => {
            ...
            await axios.post(`https://testcoffeetree.store/comment-likes/dislike/${comment.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
