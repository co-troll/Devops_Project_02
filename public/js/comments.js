...
class Comments {
    ...
    async createComment(postId, content) {
        await axios.post(`/comment/createComment`, { postId, content }, {
...
`;
    ...
    async modifyComment(commentId, content) {
        await axios.put(`/comment/${commentId}`, { content }, {
            withCredentials: true
        });
    }
...
const commentRender = async () => {
    ...
    commentLikeBtn.forEach((el) => {
        el.onclick = async (e) => {
            ...
            await axios.post(`/comment-likes/like/${comment.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
    commentDisLikeBtn.forEach((el) => {
        el.onclick = async (e) => {
            ...
            await axios.post(`/comment-likes/dislike/${comment.dataset.id}`, {}, {
                withCredentials: true
            });
        };
    });
